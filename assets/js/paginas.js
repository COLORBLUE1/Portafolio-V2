/**
 * Cambiar proyectos de diseño a programación y al revés
 */
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Estilo inicial para el elemento 'active'
  ...
  activeElement.style.boxShadow = "3px 1px 17px -6px rgba(0, 0, 0, 69%)";
  ...
  navItems.forEach((navItem) => {
    navItem.addEventListener("click", (event) => {
      ...
      // Mostrar la sección activa basada en la selección
      ...
      event.target.style.boxShadow = "3px 1px 17px -6px rgba(0, 0, 0, 69%)";
